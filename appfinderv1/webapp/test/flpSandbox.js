		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Finder",
									"targetURL": "#commindsetacceleratorappfinder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commindsetacceleratorappfinder-display": {
								"semanticObject": "commindsetacceleratorappfinder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mindset.accelerator.appfinder",
									"url": sap.ui.require.toUrl("com/mindset/accelerator/appfinder")
								}
							}
						}
					}
