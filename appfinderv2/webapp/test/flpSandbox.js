		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Finder",
									"targetURL": "#commindsetacceleratorappfinderv2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commindsetacceleratorappfinderv2-display": {
								"semanticObject": "commindsetacceleratorappfinderv2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mindset.accelerator.appfinder.v2",
									"url": sap.ui.require.toUrl("com/mindset/accelerator/appfinder/v2")
								}
							}
						}
					}
