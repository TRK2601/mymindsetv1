sap.ui.define(["sap/ui/core/mvc/Controller", "sap/m/MessageBox", "sap/ui/model/json/JSONModel", "sap/fe/core/PageController", "sap/ui/core/routing/History", 'sap/ui/export/library',
  'sap/ui/export/Spreadsheet', 'sap/m/MessageToast', "sap/ui/model/Filter", "sap/ui/model/FilterOperator"], function (Controller, MessageBox, JSONModel, PageController, History, exportLibrary, Spreadsheet, MessageToast, Filter, FilterOperator) {
    "use strict";
    ...
    return PageController.extend("com.mindset.ui.assetwise.ext.view.MassUpload", {
      onInit: function () {
        controller = this;
      ...
      onFileUploadChange: async function (event) {
        ...
        const ownerDataUrl = `/odata/v4/assetwise/Employee?$filter=isOwner eq true`;
        const matDataUrl = `/odata/v4/assetwise/MaterialType`;
        const aStatusUrl = `/odata/v4/assetwise/AssetStatus`;
      ...
      getDeepValidationData: function (curData,baseLocData,funLocData,groupData,subGroupData) {
        ...
        return new Promise(function (resolve, reject) {
          $.get({
            url: `/odata/v4/assetwise/MaterialType?$expand=assignedCurrencies,assignedBaseLocations,assignedFunctionalLocations,assignedGroups,assignedSubGroups,assignedAssetStatus`,
            success: function (data) {
              for (let i = 0; i < data.value.length; i++) {
      ...
      handleUploadPress: function (oEvent) {
        ...
        for (let i = 0; i < aUploadedExcelData.length; i++) {
          ...
          this._handleDateColsOfExcel(payload, "Scrapping Date", "assetScrappedDate", aUploadedExcelData[i]);
        ...
        $.ajax({
          url: `/odata/v4/assetwise/postMultipleData`,
          method: "POST",
      ...
      _makeAJAXCall: function (payload) {
        ...
        return new Promise(function (resolve, reject) {
          $.ajax({
            url: `/odata/v4/assetwise/AssetMaster(ID=${payload.ID},IsActiveEntity=true)`,
            method: "PATCH",
      ...
      handleMessagePopoverPress: function (oEvent) {
        if (!this.oMessagePopover) {
          this.oMessagePopover = sap.ui.xmlfragment("com.mindset.ui.assetwise.ext.fragment.Errors", this);
