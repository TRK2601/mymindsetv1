sap.ui.define(['sap/ui/core/mvc/ControllerExtension',"sap/ui/core/routing/History", "com/mindset/ui/assetwisepg/ext/controller/Attachments"], function (ControllerExtension,History, Attachments) {
	'use strict';
	var assetId,localModel,controller, mainModel;
	let getAttachmentsState = true;
	return ControllerExtension.extend('com.mindset.ui.assetwisepg.ext.controller.ObjectPageExt', {
		...
		override: {
			...
			routing: {
				onAfterBinding: function (oBindingContext, mParameters) {
					...
					var idFacet = this.getView().byId("com.mindset.ui.assetwisepg::AssetMasterObjectPage--fe::FormContainer::GeneratedFacet1::FormElement::DataField::ID");
					var qrcodeBtn = this.getView().byId("com.mindset.ui.assetwisepg::AssetMasterObjectPage--fe::CustomAction::QRCodeAction").setIcon('sap-icon://qr-code');
					var uploadAssetImgBtn = this.getView().byId("com.mindset.ui.assetwisepg::AssetMasterObjectPage--fe::CustomAction::UploadAssetImgID");
             ...
             * @memberOf com.mindset.ui.assetwisepg.ext.controller.ObjectPage
             */
			onInit: function () {
			...
			onBeforeRendering: function(){
				this.getView().byId("com.mindset.ui.assetwisepg::AssetMasterObjectPage--fe::CustomAction::QRCodeAction").setIcon('sap-icon://qr-code')
				this.getView().byId("com.mindset.ui.assetwisepg::AssetMasterObjectPage--fe::CustomAction::QRCodeAction").setIcon('sap-icon://qr-code').setType('Emphasized');
				this.getView().byId("com.mindset.ui.assetwisepg::AssetMasterObjectPage--fe::CustomAction::UploadAssetImgID").setIcon('sap-icon://attachment');
			},
		},
		...
		formatValues: function(selOp,currkey,prevField,currField) {	
			...
			else if(currkey == "assetScrappedDate" || currkey == "assetActScrappedDate" || currkey == "assetScrappedValue" || currkey == "assetScrappedValueCur_code" || currkey == "assetScrappedOwner" || currkey == "openTextBox5"){
				if(selOp === 'C' && currField){
		...
		currkeyFormatter: function (fieldName) {
			switch (fieldName) {
				...
				case "assetScrappedDate":
					return "Planned Scrapped Date";
					break;
				case "assetActScrappedDate":
					return "Actual Scrapped Date";
					break;
