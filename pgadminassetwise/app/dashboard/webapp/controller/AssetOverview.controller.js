sap.ui.define([
     ...
     */
    function (Controller, ChartFormatter, Filter, VizTooltip, UIComponent, MessageToast) {
        "use strict";
        var oLocalModel, oController;
        return Controller.extend("com.mindset.ui.assetwisepg.dashboard.controller.AssetOverview", {
            onInit: function () {
                oController = this;
            ...
            handleRouteMatch:function(){
                let sUrl = this.getOwnerComponent().getModel().sServiceUrl;
                oLocalModel.setProperty("/AssetDataSet", []);
                $.ajax({
                    url: sUrl + "AssetMaster",
                    method: "GET",
            ...
            dataModification:function(){
                ...
                oLocalModel.setProperty("/sSelectedBaseLocation", oLocalModel.getProperty("/AssetDataSet")[0] && oLocalModel.getProperty("/AssetDataSet")[0].baseLocation);
                oLocalModel.setProperty("/sSelectedAssetGrp", oLocalModel.getProperty("/AssetDataSet")[0] && oLocalModel.getProperty("/AssetDataSet")[0].group);
            ...
            onSelectBaseLocationChange:function(){
                ...
                if(!sSelectedBaseLoc || sSelectedBaseLoc === null || sSelectedBaseLoc === ""){
                    sSelectedBaseLoc = (aAssetData[0] && aAssetData[0].baseLocation) || "";
                }
            ...
            onAssetGroupChange:function(){
                ...
                if(!sSelectedKey || sSelectedKey === null || sSelectedKey === ""){
                    sSelectedKey = (aAssetData[0] && aAssetData[0].group) || "";
                }
                var aFilteredBaseLocData = [];
                aFilteredBaseLocData = aAssetData.filter(function(el){
            ...
            onProcurementDatePress:function(){
                ...
                } else if (oFromDate != null || oToDate != null){
                    MessageToast.show("Please select From & To Date fields...!");
                    oController.addingDatetoData(oLocalModel.getProperty("/AssetDataSet") || []);
                } else {
                    oController.addingDatetoData(oLocalModel.getProperty("/AssetDataSet") || []); 
                }
