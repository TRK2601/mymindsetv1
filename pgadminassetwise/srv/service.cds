using { com.mindset.postgres.db.assetwise as schema } from '../db/data-model';

annotate assetwise_pg.AssetMaster with @odata.draft.enabled : true;
annotate assetwise_pg.AssetMaster with @fiori.draft.enabled : true;

@(requires: 'authenticated-user')
service assetwise_pg @(path: '/odata/v4/assetwise_pg') {
